          ...
          SliverFillRemaining(
            child: ValueListenableBuilder<List<ContactGroup>>(
              ...
              builder: (context, contactLists, child) {
                const groupIcon = Icon(CupertinoIcons.group, size: 32);

                const pairIcon = Icon(CupertinoIcons.person_2, size: 24);
...
class ContactGroupsSidebar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return _ContactGroupsView(
      ...
      onListSelected: (contactGroup) => onListSelected(contactGroup.id),
    );
  }
}
